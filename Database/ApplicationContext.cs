...
namespace SchedulePlanner.Database
{
    internal class ApplicationContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=localhost,1433;Database=EducationPlans;User Id=SA;Password=YourStrong!Password123;TrustServerCertificate=True;MultipleActiveResultSets=true");
        }
    }
}
